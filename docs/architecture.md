...
- Currently, only RHEL 8/9 CentOS 8/9, Debian 11/12 and Ubuntu 22/24 are supported.
...
spawned by JupyterHub is essentially a batch job. A basic
[spawn form](https://github.com/jupyterhub/jupyterhub/tree/main/examples/spawn-form)
will be installed with the playbook. Just before spawning a
...
basic authentication (when supported).
