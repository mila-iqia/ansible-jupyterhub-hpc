...
"""Verification tests for setup_grafana"""
...
expected_cfg_files = ['/var/lib/grafana/dashboards/jupyterhub-dashboard.json',
                      '/etc/grafana/grafana.ini', '/etc/logrotate.d/grafana']

# Expected cert files
expected_tls_files = ['/etc/grafana/ssl/cert/grafana-node.crt',
                      '/etc/grafana/ssl/private/grafana-node.key']
